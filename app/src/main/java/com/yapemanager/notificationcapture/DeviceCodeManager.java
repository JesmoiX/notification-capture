...
public class DeviceCodeManager {
    ...
    private void syncStatusFromFirebase() {
        try {
            ...
            com.google.firebase.database.FirebaseDatabase database = com.google.firebase.database.FirebaseDatabase
                    .getInstance(
                            firebaseApp,
    ...
    private void registerDeviceInFirebase() {
        try {
            ...
            com.google.firebase.database.DatabaseReference devicesRef = database.getReference("devices")
                    .child(deviceCode);
